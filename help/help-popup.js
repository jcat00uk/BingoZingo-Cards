/* =============================================
   BingoBongo Help System — help-popup.js
...
(function () {
  ...
  function openPopup(key) {
    ...
    // Mark first use
    if (!localStorage.getItem('bingobongo_help_used')) {
      localStorage.setItem('bingobongo_help_used', '1');
    }
  }
  ...
  function showFirstVisitHint() {
    if (localStorage.getItem('bingobongo_help_used')) return;
    if (localStorage.getItem('bingobongo_help_hint_shown')) return;
    ...
    localStorage.setItem('bingobongo_help_hint_shown', '1');
  }
  ...
  function initDotsToggle() {
    ...
    if (localStorage.getItem('bingobongo_help_dots_hidden') === '1') {
    ...
    document.querySelectorAll('.help-dots-toggle').forEach(function(btn) {
      ...
      btn.addEventListener('click', function() {
        ...
        localStorage.setItem('bingobongo_help_dots_hidden', hidden ? '1' : '0');
